...
class ClubMember(BaseModel):
    ...
    # Role & Position
    role = Column(
        SQLEnum(ClubRole, name='club_role_enum'),
    ...
    def is_owner(self) -> bool:
        ...
        return self.role == ClubRole.OWNER
    
    @property
    def is_admin_or_owner(self) -> bool:
        """Check if member has admin privileges"""
        return self.role in [ClubRole.OWNER, ClubRole.ADMIN]
    
    @property
    def can_manage(self) -> bool:
        """Check if member can manage club content"""
        return self.role in [ClubRole.OWNER, ClubRole.ADMIN, ClubRole.MANAGER]
